...
class DataClass extends Command implements PromptsForMissingInput
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:data-class {namespace} {action}';
    ...
    public function handle(): void
    {
        ...
        if (! File::exists($relativeDirectory.ucfirst($action).'.php')) {
            $formRequestContent = File::get($currentWorkingDirectory.'/app/Console/TemplateGenerator/stubs/data-class.txt');
