...
import { ArrowLeft, Edit, Trash2, FileText, Database, Layers } from 'lucide-react'
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='flex items-center gap-4'>
                        ...
                        <span className='inline-flex items-center gap-1.5 rounded-md border border-purple-100 bg-purple-50 px-3 py-1 text-sm text-purple-700'>
                          ...
                          {/* Placeholder for hierarchy as it's not directly in widget root, assuming it might be in data or just generic */}
                          Hierarchy Details
                        </span>
                      </div>
