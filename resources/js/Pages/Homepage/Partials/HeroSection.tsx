...
export default function HeroSection({
  ...
  return (
    <div className='relative mx-4 mb-8 mt-6 flex min-h-[500px] flex-col overflow-hidden rounded-[40px] px-4 pb-16 pt-6 font-sans text-white shadow-sm'>
      ...
      <div className='relative z-10 flex w-full justify-end gap-3 px-6 pt-2'>
        <button
          ...
          className='rounded-lg bg-white/20 p-2 backdrop-blur-md transition-all hover:scale-105 hover:bg-white/30'
        >
      ...
      <div className='relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col items-center justify-center text-center'>
        ...
        >
          Hi, {user?.name ? startCase(user.name) : 'there'}!
        </motion.h2>
        ...
        >
          ...
          <div className='relative overflow-hidden rounded-[28px] bg-gradient-to-r from-emerald-400/40 via-blue-500/40 to-indigo-500/40 p-[1px] shadow-2xl backdrop-blur-sm'>
            {/* Inner Content */}
            <div className='flex flex-col rounded-[27px] bg-white/10 p-1 px-2 pb-2 backdrop-blur-md'>
              {/* Tabs */}
              ...
              <form
                ...
                className='relative mt-1 flex flex-col rounded-[24px] bg-white p-2 shadow-lg transition-all focus-within:shadow-xl'
              >
                <div className='relative px-2 pt-2'>
                  <div className='absolute left-3 top-4'>
                    <Sparkles className='h-5 w-5 fill-purple-400 text-purple-400' />
                  </div>
                  <textarea
                    value={query}
                    ...
                    className='scrollbar-hide min-h-[90px] w-full resize-none border-none bg-transparent py-3 pl-10 pr-4 text-[15px] leading-relaxed text-slate-600 placeholder-slate-400 focus:ring-0'
                  />
                </div>
                <div className='flex justify-end px-2 pb-2'>
                  <button
                    type='submit'
                    disabled={!query.trim()}
                    className='flex h-10 w-10 items-center justify-center rounded-full bg-[#4ade80] text-white shadow-md transition-all hover:scale-105 hover:bg-[#22c55e] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100'
                  >
        ...
        >
          ...
          >
            ...
            <span className='border-b border-dashed border-white/40 pb-0.5 decoration-white/40 group-hover:border-white'>
              Manage Dashboard
            </span>
          </button>
          <button
