...
export default function Homepage({
  ...
  const [activeTab, setActiveTab] = useState<
    'personal' | 'community' | 'all' | 'dashboard' | 'widgets'
  >('all')
          ...
          <div className='relative'>
            ...
            >
              ...
              <svg
                ...
                className={`h-4 w-4 text-gray-400 transition-transform ${isExploreDropdown ? 'rotate-180' : ''}`}
              >
                <path d='m6 9 6 6 6-6' />
              </svg>
            </button>
          ...
          <div className='inline-flex rounded-full bg-gray-100 p-1'>
            <button
              ...
              className={`rounded-full px-6 py-2 text-sm font-medium transition-all duration-200 ${
                activeTab === 'personal' // This logic might need adjustment if logic changes
            ...
            <button
              className={`rounded-full px-6 py-2 text-sm font-medium text-gray-500 transition-all duration-200 hover:text-gray-900`}
            >
              Dashboard
            </button>
            <button
