...
>({
  ...
  return (
    <DashboardPadding>
      <div className='pb-5'>
        This section of the application defines standardized data values and structures allowed in
        data tables. Maintaining standard values and structures helps ensure data in the system
        remains valid, and can automatically be rolled-up as necessary into higher levels
        ofreporting.
      </div>
      <Card>
