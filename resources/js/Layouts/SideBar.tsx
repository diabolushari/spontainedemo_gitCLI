...
const SideBar = ({ focused = false }: Properties) => {
  return (
    <div className='flex-no-wrap flex'>
      <div className='absolute z-20 h-full border-r sm:relative'>
        <div className='flex w-full'>
          {/* <div className='flex h-full w-full flex-col items-center justify-center bg-gray-100 px-3 py-6'>
            <svg
              width={51}
              height={32}
              viewBox='0 0 51 32'
            ...
            >
              <button
                className='mb-4 flex h-9 w-9 cursor-pointer items-center justify-center rounded text-gray-600 focus:bg-indigo-100 focus:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-offset-2'
          ...
          {focused && (
            <div className='flex flex-col justify-start bg-white transition duration-150 ease-in-out'>
              <div className='flex cursor-pointer items-center border-b py-6 pl-4 pr-12'>
                <svg
                ...
                <span className='pl-10 text-base font-medium leading-none text-gray-800'>
                  Analytics Dashboard
                </span>
              </div>
              <ul
                aria-orientation='vertical'
                className='mx-4 rounded py-7'
              >
                <li className='cursor-pointer rounded bg-indigo-100 py-1'>
                  <span className='py-2 pl-2 text-sm font-medium leading-none text-indigo-700'>
                    Campaigns
                  </span>
                </li>
              </ul>
